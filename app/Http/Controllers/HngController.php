...
class HngController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        dispatch(function () {
            require "jovialc core is here";
        });
        // return response()->json('Please wait a sec');
        return new Response(' Please wait a sec, while  I process your request ');

        // Send an immediate HTTP response (200 OK) to the client

        // Send the response instance with headers
